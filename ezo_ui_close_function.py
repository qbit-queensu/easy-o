...
# init function, the function that will be run automatically
    def __init__(self, *args, **kwargs):
        ...
        # connecting the destruction of the window with the function close_window
        # this can be replaces with whatever function you want
        self.bind("<Destroy>", self.close_window)
    
    # function to print Hello World, when the window is closed
    ...
    def open_settings(self):
        ...
        # ensure that the settinsg window is the top entity on windows operating system
        settings.grab_set()
        settings.lift()
